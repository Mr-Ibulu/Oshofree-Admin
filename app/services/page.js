...
const Services = () => {
  ...
  return (
    <>
      <h1 className="mb-8 text-3xl font-bold">Service Deals</h1>
      <div className="mb-8 flex flex-col items-center justify-between gap-6 rounded-xl bg-white p-4 shadow-md dark:bg-zinc-800 dark:shadow-zinc-950 sm:flex-row">
        ...
        <Button asChild>
          <Link href={"/services/create"} className="rounded-3xl">
            <MdAdd className="mr-2 text-2xl" /> Add New Service Deal
          </Link>
        </Button>
      </div>
